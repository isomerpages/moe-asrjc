...
Applications will be via this [**link**](https://portal.asrjc.edu.sg/0/apply.html) which will open on **22 Dec 2025**. All Applications are to be submitted by **09 Jan 2026**.
...
The College will only be able to consider any application for admission of international students **after** the Joint Admissions Exercise in January 2026, and if there are still available vacancies.
